...
export default function ExpenseContent(props) {
  ...
  return (
    <>
      <AddExpenseModal showModal={showModal} setShowModal={setShowModal} modalType={modalType} selectedRowId={selectedRowId} handlePageUpdate={handlePageUpdate} categoryId={categoryId}/>
      <ConfirmModal showModal={showConfirmModal} setShowModal={setShowConfirmModal} selectedRowId={selectedRowId} handlePageUpdate={handlePageUpdate} type={"expense"}/>
          ...
          <div className="mb-4 flex flex-col justify-between gap-8 md:flex-row md:items-center">
            <div>
              ...
              <Typography color="gray" className="mt-1 font-normal">
                Details about Expense of {categoryName}
              </Typography>
            </div>
            <div className="flex w-full shrink-0 gap-2 md:w-max">
              ...
              <Button className="flex items-center gap-3 bg-tertiary" size="sm" onClick={handleClickDelete}>
                <GridDeleteIcon strokeWidth={2} className="h-4 w-4" /> Delete Expense
              </Button>
